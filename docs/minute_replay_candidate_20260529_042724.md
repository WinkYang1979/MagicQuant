...
| 2026-05-26 | K_1M local archive | 28 | D_TARGETED_BREAKDOWN | 0 | 2/1/1/0 | 2/1/1/0 | 6→6 |
...
| 2026-05-27 | K_1M local archive | 44 | D_TARGETED_BREAKDOWN | 0 | 1/2/0/2 | 1/2/0/2 | 1→1 |
...
| 2026-05-28 | K_1M local archive | 55 | D_TARGETED_BREAKDOWN | 1 | 4/4/3/2 | 4/5/2/2 | 5→5 |
...
| 2026-05-29 | K_1M local archive | 8 | D_TARGETED_BREAKDOWN | 5 | 1/1/0/0 | 2/0/0/0 | 0→0 |
...
|---|---:|---|---:|---:|---:|---:|---:|---|
| A_STRICT | 3 | 9/7/4/4 | +1 | +0 | +0 | +1 | 3.0 | DISCUSS |
| B_BALANCED | 6 | 10/6/4/4 | +2 | +0 | +0 | +2 | 3.0 | DISCUSS |
| C_AGGRESSIVE_WATCH | 14 | 10/7/3/4 | +2 | -1 | +0 | +3 | 4.7 | DISCUSS |
| D_TARGETED_BREAKDOWN | 6 | 9/8/3/4 | +1 | -1 | +0 | +2 | 3.0 | DISCUSS |

## Decision

DISCUSS C_AGGRESSIVE_WATCH: improved timing with acceptable alert cost (4.7 added/useful).
...
## Candidate Signals - D_TARGETED_BREAKDOWN
