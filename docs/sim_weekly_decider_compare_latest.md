...
- CSV: `C:\MagicQuant\data\sim_weekly\compare\sim_weekly_compare_trades_latest.csv`
...
- Trade ledger CSV: `C:\MagicQuant\data\sim_weekly\compare\sim_weekly_compare_trades_latest.csv`
