...
VERSION : v0.4.1
DEPENDS : core.risk_engine.engine
...
FIXTURES = {
    ...
    "normal_entry_ok": {
        ...
        "context": {"pdt_used": 0, "cash": FIXTURE_CASH_USD, "daily_pnl": 0,
    ...
    "pdt_last_slot_guard": {
        ...
        "input": {"action_type": "new_entry", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 2, "cash": FIXTURE_CASH_USD, "confidence": 0.72,
                    "market_session": "main"},
    ...
    "pdt_exhausted_block": {
        ...
        "input": {"action_type": "new_entry", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 3, "cash": FIXTURE_CASH_USD, "confidence": 0.72,
                    "market_session": "main"},
    ...
    "tiny_qty_fee_not_worth": {
        ...
        "context": {"pdt_used": 0, "cash": FIXTURE_CASH_USD, "confidence": 0.72,
                    "market_session": "main"},
    ...
    "low_confidence_warn": {
        ...
        "input": {"action_type": "new_entry", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 0, "cash": FIXTURE_CASH_USD, "confidence": 0.45,
                    "market_session": "main"},
        "expected": {"allowed": True, "severity": "warn",
    ...
    "daily_loss_block": {
        ...
        "input": {"action_type": "new_entry", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 1, "cash": FIXTURE_CASH_USD, "daily_pnl": -400,
                    "confidence": 0.72, "market_session": "main"},
        "expected": {"allowed": False, "severity": "block",
    ...
    "drawdown_block": {
        ...
        "input": {"action_type": "new_entry", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 0, "cash": FIXTURE_CASH_USD, "drawdown_from_peak": -8.5,
                    "confidence": 0.72, "market_session": "main"},
        "expected": {"allowed": False, "severity": "block",
    ...
    "full_exit_always_allowed": {
        ...
        "context": {"pdt_used": 3, "cash": FIXTURE_CASH_USD, "daily_pnl": -500,
    ...
    "partial_exit_loose": {
        ...
        "context": {"pdt_used": 1, "cash": FIXTURE_CASH_USD, "confidence": 0.45,
                    "market_session": "main"},
        "expected": {"allowed": True},
    },
    ...
    "reverse_action": {
        ...
        "input": {"action_type": "reverse", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 1, "cash": FIXTURE_CASH_USD, "confidence": 0.72,
                    "market_session": "main",
    ...
    "boundary_daily_loss_90pct": {
        ...
        "input": {"action_type": "new_entry", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 0, "cash": FIXTURE_CASH_USD, "daily_pnl": -360,
                    "confidence": 0.72, "market_session": "main"},
        "expected": {"allowed": True, "severity": "advisory",
                     "primary_reason_code": "daily_loss_limit"},
    },
    ...
    "boundary_daily_loss_exact": {
        ...
        "input": {"action_type": "new_entry", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 0, "cash": FIXTURE_CASH_USD, "daily_pnl": -400,
                    "confidence": 0.72, "market_session": "main"},
        "expected": {"allowed": False, "severity": "block"},
    },
    ...
    "boundary_consec_losses_2": {
        ...
        "input": {"action_type": "new_entry", "ticker": "US.RKLZ",
                  "qty": 100, "entry": 15.42, "stop": 15.30, "target": 15.80},
        "context": {"pdt_used": 0, "cash": FIXTURE_CASH_USD, "consecutive_losses": 2,
                    "confidence": 0.72, "market_session": "main"},
        "expected": {"allowed": True, "severity": "pass"},
    },
    ...
    "boundary_pre_earnings_warn": {
        ...
        "context": {"pdt_used": 0, "cash": FIXTURE_CASH_USD, "days_to_earnings": 1,
                    "confidence": 0.72, "market_session": "main"},
        "expected": {"allowed": True, "severity": "advisory",
